...
Скопировать 4 файла из `references/skills/` в `.claude/skills/` целевого проекта:
- `task-add.md`
- `task-done.md`
- `task-sync.md`
- `docs-sync.md`
...
Если `CLAUDE.md`, `docs/`, `.claude/skills/` уже настроены (по маркеру «setup-agent-harness» в CLAUDE.md или наличию всех 4 skills):

- Спросить пользователя: «Harness уже установлен. Что обновить?»
  - (a) Только skills (перезаписать 4 файла из свежих шаблонов).
